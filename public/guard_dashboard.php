...
<body>
    <div class="sidebar">
        <h2><i class="fas fa-tachometer-alt"></i>Guard Dashboard</h2>
        <a href="guard_dashboard.php" class="active"><i class="fas fa-home"></i> Dashboard</a>
...
//                 loadContent('view_visitors.php'); // Reload the visitor details page to reflect changes
//             } else {
//                 alert(response.message);
//             }
//         },
